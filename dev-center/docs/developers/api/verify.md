...
| `SIMILAR_MATCH` | 지각해시 거리 < 10 | 등록 영상과 유사합니다. |
...
| `CERTIFICATE_INVALID` | VC 무효 | 블록체인 등록은 확인했지만 VC가 유효하지 않습니다. |

### 확인 불가

| verdict | 의미 | 메시지 |
|---|---|---|
| `VERIFICATION_UNAVAILABLE` | 외부 장애 | 외부 검증 서비스에 연결할 수 없습니다. |
