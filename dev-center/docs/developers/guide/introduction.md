...
::: tip 원본 장기 미보관
영상은 분석을 위해 서버로 전송됩니다. 원본을 장기 보관하지 않으며, 분석용 임시 파일은 처리 후 삭제합니다. 지문과 등록 정보 등은 검증에 사용됩니다.
:::
...
### 본인확인을 마친 등록자 (ISSUER)
모바일 신분증으로 본인확인을 마치고 Wallet DID를 연결한 회원입니다. 영상을 등록하고, 블록체인 기록과 VC 보증서를 발급받을 수 있습니다.
...
| **웹** | 영상 파일 업로드 또는 URL 입력으로 검증 | 불필요 |
| **Chrome 확장** | YouTube·Instagram 영상 URL 기반 검증 | 불필요 |
