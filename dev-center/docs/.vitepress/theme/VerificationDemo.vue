...
const examples = [
  ...
  },
  {
    ...
    status: '등록 기록을 찾지 못함', title: '등록 기록으로 확인할 수 없어요.',
    description: '현재 진본에서 비교할 등록 영상을 찾지 못한 경우입니다. 이 결과만으로 가짜나 조작 영상이라고 판단할 수 없습니다.',
    scope: '일치 여부를 확인할 수 없음', next: '공유하기 전에 원 게시자나 공식 채널에서 영상의 내용과 등록 여부를 확인하세요. 등록된 영상이 있다면 해당 파일이나 지원하는 링크로 다시 검증할 수 있습니다.',
